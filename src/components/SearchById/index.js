...
class SearchById extends React.Component {
  ...
  actionSearch() {
    ...
    getApiById(query, count, page, getToken()).then(response => {
  ...
  renderNavBar = () => (
    <Grid container>
      ...
      <Grid item>
        <Link href={K_ROUTE_BY_NAME} variant="body2">
...
SearchById.propTypes = {
  classes: PropTypes.object.isRequired,
  setToken: PropTypes.func.isRequired,
  getToken: PropTypes.func.isRequired
};

export default withStyles(styles)(SearchById);
